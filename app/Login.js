...
export default function Login({ onLogin, switchToSignup }) {
  ...
  return (
    <Box
      ...
      alignItems="center"
      sx={{
        backgroundImage: 'url(/pngtree-march-vegetable-and-fruit-season-cartoon-loquat-promotion-banner-picture-image_1079427.jpg)',
    ...
    >
      ...
      >
        ...
        <Link
          ...
          sx={{ textDecoration: 'none', color: '#ff5722', '&:hover': { color: '#e64a19' } }}
        >
